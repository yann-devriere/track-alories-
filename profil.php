  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form class="formUpdate" method="POST" action="./class/updateUser.php"> <h3>Un changement physique ?</h3>
            <div class="innerMenu">
             <p>Nouveau poids</p>
                <input class="form-control" type="number" name="newPoids" required placeholder="Nouveau poids en kg"></input>
             <p class="mt-5">Nouvelle taille</p>
                <input class="form-control" type="decimal" name="newTaille"  required placeholder="Nouvelle taille en m"></input>
                <div class="btnSpot">
